...
getAllEpisodes().forEach((episode) =>{
  ...
  seasonDetails.innerText = `Season: ${episode.season} - Episode: ${episode.number}`
  createEpisodeDetails.innerText = `Summary : ${episode.summary.slice(3, episode.summary.length - 4)}`
  // appending elements
  div.appendChild(individualDiv)
  individualDiv.append(createEpisodeTitle,createEpisodeImg,seasonDetails,createEpisodeDetails)
